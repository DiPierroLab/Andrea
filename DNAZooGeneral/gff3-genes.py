...
with open('/Users/andreafalcon/Dropbox/PostDoc_NEU/orthofinder_data/Orthogroups.txt', 'r') as archivo:
...
for j in range(len(species)):
    ...
    if(response_json.status_code == 200):
        ...
        if (response.status_code == 200):
            ...
            urllib.request.urlretrieve(url_specie + gff3_name, '/Users/andreafalcon/' + gff3_name)
            
            with gzip.open('/Users/andreafalcon/' + gff3_name, 'rb') as f_in:
                with open('/Users/andreafalcon/' + gff3_name.replace('.gz',''), 'wb') as f_out:
                    shutil.copyfileobj(f_in, f_out)
                    
            os.remove('/Users/andreafalcon/' + gff3_name)
    
            annotation = gffpd.read_gff3('/Users/andreafalcon/' + gff3_name.replace('.gz',''))
            ...
            df_chrom.to_csv('/Users/andreafalcon/Dropbox/PostDoc_NEU/DNAZoo/GeneAnnotation/' + binomial.replace(' ','_') + '.csv', encoding='utf-8', index=False, header=True)
            
            os.remove('/Users/andreafalcon/' + gff3_name.replace('.gz',''))
